...
plt.savefig('/media/usuario/datos/results/charts/test')
# plt.show()
plt.close()
...
epochs = 600
model = Sequential()
model.add(LSTM(25,return_sequences=True, input_shape=x_train[1].shape,kernel_initializer='glorot_uniform'))
model.add(LSTM(25))
model.add(Dropout(0.2))
model.add(Dense(2, activation='softmax'))
adas = optimizers.Adam()

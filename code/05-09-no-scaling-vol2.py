...
start = time.time()
history = model.fit(x_train,y2_train, epochs = epochs, batch_size = batch_size, verbose = 2, validation_data = (x_test, y2_test))
end = time.time()
...
print('model' + name + 'zakonczony powodzeniem')

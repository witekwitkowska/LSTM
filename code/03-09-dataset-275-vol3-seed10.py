...
import pickle
with open('/media/usuario/datos/results/history-03-09-dataset-275-vol3-seed10', 'wb') as file_pi:
    pickle.dump(history.history, file_pi)
# saving whole model
model.save('/media/usuario/datos/results/models/lstm_model-03-09-dataset-275-vol3-seed10.h5')

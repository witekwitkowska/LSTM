...
#Load from raw data
#Load dominant class
dataFolders = sorted(listdir('/media/usuario/datos/new-voltage-dips/'))
# print(dataFolders)
numClass = 0
classDips = 1000
nonClassDips = 70
...
dataFolders = ['/media/usuario/datos/new-voltage-dips/' + f for f in dataFolders if exists(join('/media/usuario/datos/new-voltage-dips/',f))]
...
for clas in dataFolders:
    # print(clas)
    if clas=='/media/usuario/datos/new-voltage-dips/0-1k_falla_1f':
        continue
    dipsCounter = 0
...
history = model.fit(x_train_norm,y2_train, epochs = epochs, batch_size = batch_size, verbose = 1, validation_data = (x_test_norm, y2_test))
import pickle
with open('/media/usuario/datos/results/history-03-09-dataset-300-vol4-seed123', 'wb') as file_pi:
    pickle.dump(history.history, file_pi)
# saving whole model
model.save('/media/usuario/datos/results/models/lstm_model-03-09-dataset-300-vol4-seed123.h5')
print('zakonczone powodzeniem')
